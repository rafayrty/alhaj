...
currentTab:any = 'history'
  constructor(private store:StorageService,private router:Router, private translate:TranslateService,private loadingController:LoadingController,private dataService:DataService,private storage:Storage) {
